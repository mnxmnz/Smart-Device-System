...
const serverbody = (request, response) => {
    fs.readFile('plotly_joy.html', 'utf8', (err, data) => {
...
server.listen(60001, () => {
    ...
    console.log('------------------------------------------');
    console.log('조이스틱 제어용 웹 서버');
    console.log('웹 브라우져 접속 주소 : http://IP주소:60001/');
    console.log('------------------------------------------');
});